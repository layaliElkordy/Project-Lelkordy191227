...
public class InsertFirebase extends AppCompatActivity {
    String getidf,getemailf,getfnamef,getlnamef,getnumberf;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_insert_firebase);
        ...
        Button  insertbttn = (Button)findViewById(R.id.updatedatabttn);
        ...
        insertbttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebase.AddRecord(getemailf,getfnamef,getlnamef,getnumberf,getidf);
                Toast.makeText(InsertFirebase.this,"New Record Added Successfully",Toast.LENGTH_SHORT).show();
            }
        });
